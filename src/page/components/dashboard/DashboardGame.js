...
import { Dimmer, Loader, Image, Segment, Header, Card } from 'semantic-ui-react'
...
class DashboardGame extends Component {
  ...
  getCard (id) {
    ...
    history.push(`/dashboard/games/${id}`)
  }

  componentDidMount () {
    getGames(this.props.user)
      ...
      <Fragment>
        <div className='container'>
          ...
          <Card.Group itemsPerRow={6}>
            { games.map((game) => (
              <Card raised key={game._id} image={game.image_url} onClick={() => this.getCard(game._id)}/>
            ))}
          </Card.Group>
        </div>
      </Fragment>
...
export default withRouter(DashboardGame)
