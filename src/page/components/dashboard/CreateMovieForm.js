      ...
      <Fragment>
        ...
        <Form onSubmit={this.handleSubmit} encType="multipart/form-data">
          <Form.Group widths='equal'>
            <Form.Input fluid label='Movie Title' placeholder='Movie Title' name='title' onChange={this.handleChange} required/>
            <Form.Input fluid label='IMDB Rate' placeholder='IMDB Rate' type="number" name='imdbRating' min="0" max='10' step="0.1" onChange={this.handleChange} required/>
          </Form.Group>
          <Form.Group widths='equal'>
            <DateInput
              ...
              required
            />
            <Form.Input label='Image' name="imageUrl" type="file" onChange={this.handleChange} required/>
            <Form.Input label='Trailer Url' name='trailer' onChange={this.handleChange} required/>
          </Form.Group>
          <Form.TextArea label='Description' placeholder='Tell us more about Movie...' name='description' onChange={this.handleChange} required/>
