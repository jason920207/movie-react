...
class DashboardMovies extends Component {
  ...
  getCard (id) {
    ...
    history.push(`/dashboard/updatemovie/${id}`)
  }
      ...
      <Fragment>
        <div className='container'>
          ...
          <Card.Group itemsPerRow={6}>
            { movies.map((movie) => (
              <Card raised key={movie._id} image={movie.imageUrl} onClick={() => this.getCard(movie._id)}/>
            ))}
          </Card.Group>
        </div>
      </Fragment>
...
export default withRouter(DashboardMovies)
