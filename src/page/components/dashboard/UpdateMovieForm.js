      ...
      <Fragment>
        ...
        <Form onSubmit={this.handleSubmit} encType="multipart/form-data">
          <Form.Group widths='equal'>
            <Form.Input fluid label='Movie Title' placeholder='Movie Title' name='title' value={this.state.title} onChange={this.handleChange}/>
            <Form.Input fluid label='IMDB Rate' placeholder='IMDB Rate' name='imdbRating' value={this.state.imdbRating} onChange={this.handleChange}/>
          </Form.Group>
          <Form.Group widths='equal'>
            <DateInput
          ...
          <Form.TextArea label='Description' placeholder='Tell us more about Movie...' value={this.state.description} name='description' onChange={this.handleChange}/>
          <Form.Group>
